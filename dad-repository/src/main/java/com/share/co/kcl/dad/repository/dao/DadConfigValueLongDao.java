...
/**
 * 动态广告-配置项LONG值(DadConfigValueLong)表数据库访问层
 *
 * @author makejava
 * @since 2023-02-15 14:25:34
 */
@Mapper
public interface DadConfigValueLongDao extends BaseMapper<DadConfigValueLong> {

    List<ConfigAttributeValueSelectResult<Long>> selectConfigAttributeValue(@Param("params") ConfigAttributeValueSelectParams params);
