...
/**
 * 动态广告-配置项INT值(DadConfigValueInt)表数据库访问层
 *
 * @author makejava
 * @since 2023-02-15 14:25:34
 */
@Mapper
public interface DadConfigValueIntDao extends BaseMapper<DadConfigValueInt> {

    List<ConfigAttributeValueSelectResult<Integer>> selectConfigAttributeValue(@Param("params") ConfigAttributeValueSelectParams params);
